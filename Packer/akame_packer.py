...
if __name__ =="__main__" :
    ...
    parser = argparse.ArgumentParser(description='Akame PE Packer')
    parser.add_argument('input', metavar="FILE.exe", help='input file')
    ...
    compile_stub("akame_stub.c", "akame_stub.exe", more_parameters=[]);

    # open the akame_stub.exe binary
    unpack_PE = lief.PE.parse("akame_stub.exe")
    ...
    if ASLR:
        ...
        compile_stub("akame_stub.c", "shifted_akame_stub.exe", compile_parameters)

        unpack_shifted_PE = lief.PE.parse("shifted_akame_stub.exe")
